    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createexpertratingsubmit");?>' enctype='multipart/form-data'>
                    <div class="panel-body">
                        <div class=" form-group">
                            <label class="col-sm-2 control-label" for="normal-field">Expert</label>
                            <div class="col-sm-4">
                                <?php echo form_dropdown( "expert",$expert,set_value( 'expert'), "class='chzn-select form-control'");?>
                            </div>
                        </div>
...
-->
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="number" min="0" max="5" step="0.5" id="normal-field" class="form-control" name="rating" value='<?php echo set_value(' rating ');?>'>
                            </div>
                        </div>
