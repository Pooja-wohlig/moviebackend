<section class="panel">
    ...
    <div class="panel-body">
        <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editwatchsubmit");?>' enctype='multipart/form-data'>
...
-->
            <div class=" form-group">
                ...
                <div class="col-sm-4">
                    <?php echo form_dropdown( "movie",$movie,set_value( 'movie',$before->movie),"class='chzn-select form-control' disabled='disabled'");?>
                </div>
            </div>
