...
class restapi_model extends CI_Model
{
	...
	$query['theatresthisweek']=$this->db->query("SELECT `id`, `name`, `duration`, `dateofrelease`, `rating`, `director`, `writer`, `casteandcrew`, `summary`, `twittertrack`, `trailer`, `isfeatured`, `iscommingsoon`, `isintheator` FROM `movie_movie` WHERE `isintheator`='1'")->result();
		return $query;
	}
	
public function isfeatured(){
	$query['isfeatured']=$this->db->query("SELECT `id`, `name`, `duration`, `dateofrelease`, `rating`, `director`, `writer`, `casteandcrew`, `summary`, `twittertrack`, `trailer`, `isintheator`, `iscommingsoon`, `isfeatured`
 FROM `movie_movie` WHERE `isfeatured`='1'")->result();
    ...
    public function userdetails($user)
    {
		...
		$query['watched']=$this->db->query("SELECT `movie_movie`.`id`, `movie_movie`.`name`, `movie_movie`.`duration`, `movie_movie`.`dateofrelease`, `movie_movie`.`rating`, `movie_movie`.`director`, `movie_movie`.`writer`, `movie_movie`.`casteandcrew`, `movie_movie`.`summary`, `movie_movie`.`twittertrack`, `movie_movie`.`trailer`, `movie_movie`.`isfeatured`, `movie_movie`.`iscommingsoon`, `movie_movie`.`isintheator`  FROM `movie_movie` LEFT OUTER JOIN `movie_watch` ON `movie_movie`.`id`=`movie_watch`.`movie` WHERE `movie_watch`.`user`='$user'")->result();
		...
		$query['ratings']=$this->db->query("SELECT `movie_userrate`.`user`,`movie_movie`.`id`, `movie_movie`.`name`, `movie_movie`.`duration`, `movie_movie`.`dateofrelease`, `movie_movie`.`rating`, `movie_movie`.`director`, `movie_movie`.`writer`, `movie_movie`.`casteandcrew`, `movie_movie`.`summary`, `movie_movie`.`twittertrack`, `movie_movie`.`trailer`, `movie_movie`.`isfeatured`, `movie_movie`.`iscommingsoon`, `movie_movie`.`isintheator`,`movie_userrate`.`rating` FROM `movie_userrate` LEFT OUTER JOIN `movie_movie` ON `movie_userrate`.`movie`=`movie_movie`.`id` WHERE `movie_userrate`.`user`='$user'")->result();
		...
		$query['reviewed']=$this->db->query("SELECT `movie_movie`.`id`, `movie_movie`.`name`, `movie_movie`.`duration`, `movie_movie`.`dateofrelease`, `movie_movie`.`rating`, `movie_movie`.`director`, `movie_movie`.`writer`, `movie_movie`.`casteandcrew`, `movie_movie`.`summary`, `movie_movie`.`twittertrack`, `movie_movie`.`trailer`, `movie_movie`.`isfeatured`, `movie_movie`.`iscommingsoon`, `movie_movie`.`isintheator`, `movie_review`.`review` FROM `movie_movie` LEFT OUTER JOIN `movie_review` ON `movie_movie`.`id`=`movie_review`.`movie` WHERE `movie_review`.`user`='$user'")->result();
		...
		$query['recommended']=$this->db->query("SELECT `movie_userrecommend`.`recommendfriend` AS `recommended_id`,`user`.`name` AS `recommended_friend`,`movie_movie`.`id`, `movie_movie`.`name`, `movie_movie`.`duration`, `movie_movie`.`dateofrelease`, `movie_movie`.`rating`, `movie_movie`.`director`, `movie_movie`.`writer`, `movie_movie`.`casteandcrew`, `movie_movie`.`summary`, `movie_movie`.`twittertrack`, `movie_movie`.`trailer`, `movie_movie`.`isfeatured`, `movie_movie`.`iscommingsoon`, `movie_movie`.`isintheator` FROM `movie_movie` LEFT OUTER JOIN `movie_userrecommend` ON `movie_movie`.`id`=`movie_userrecommend`.`movie` LEFT OUTER JOIN `user` ON `movie_userrecommend`.`recommendfriend`=`user`.`id` WHERE `movie_userrecommend`.`user`='$user'")->result();
...
//$query['moviedetails']=$this->db->query("SELECT `id`, `name`, `duration`, `dateofrelease`, `rating`, `director`, `writer`, `casteandcrew`, `summary`, `twittertrack`, `trailer`, `isfeatured`, `iscommingsoon`, `isintheator` FROM `movie_movie` WHERE `id`='$movieid'")->result();
	...
	$query['description']=$this->db->query("SELECT `id`, `name`, `duration`, `dateofrelease`, `rating`, `director`, `writer`, `casteandcrew`, `summary`, `twittertrack`, `trailer`, `isfeatured`, `iscommingsoon`, `isintheator` FROM `movie_movie` WHERE `id`='$movieid'")->row();
